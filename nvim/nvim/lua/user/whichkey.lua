...
local mappings = {
  ...
  l = {
    ...
    -- I = { "<cmd>lua require('telescope.builtin').lsp_outgoing_calls()<cr>", "Outgoing calls" },
  ...
  t = {
    ...
    name = "Tasks",
    C = { "<cmd>Task start cmake configure<cr>", "CMAKE configure project"},
    R = { "<cmd>Task start cmake run<cr>", "CMAKE build + run project"},
    D = { "<cmd>Task start cmake debug<cr>", "CMAKE build + debug project"},
  },
